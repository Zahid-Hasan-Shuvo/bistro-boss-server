...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.c5zvbtl.mongodb.net/?retryWrites=true&w=majority`;
...
app.patch('/users/admin/:id',  async(req,res)=>{
  ...
  res.send(result)
    ...
    // for  load  all reviews data using find
